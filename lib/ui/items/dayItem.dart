...
class DayItem extends StatelessWidget {
  ...
  DayItem({required this.index,this.positionNum = 0,required this.element,this.isFirst = false});
  ...
  Widget build(BuildContext context) {
    return AnimationScaleWidget(
      ...
      child: GestureDetector(
        onTap: () {
          utils.goToNextScreen(
              context, DetailsPage(index));
        },
        child: Container(
            width: 100,
            ...
            child: Column(
              ...
              children: [
                ...
                Hero(
                  tag: index,
                  child: Image.asset(
                    helperWidget.imagePath[element
                        .weather!
                        .first
                        .icon],
                    height: 40,
